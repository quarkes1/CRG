...
- 点击<a href = "https://m.mugzone.net/page/all/chart?type=3">这里</a>前往官网下载
...
- 由于本程序不支持Malody的ogg vorbis , 因此需要将.ogg文件转为更通用的.MP3格式（若用wav占用过大） 可以去 <a href = "https://www.freeconvert.com/">这里</a>进行转换。